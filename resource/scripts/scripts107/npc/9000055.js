        ...
        if (status == 0) {
            if (cm.getMapId() == 910023100 || cm.getMapId() == 910023400) {
                ...
                if (cm.getChannelServer().getChannel() == 1) {
                    ...
                    text += "#r幽默时刻:" + hwtext[hwchance] + "#k\r\n#b(如果你触摸移动墙或上升的巧克力饼干，那么你会反弹出来)\r\n#r简单模式#k：每完成一次可获得1-2个#v4000313##z4000313#\r\n#r简单模式#k：每天可免费进入2次，2次后需20#z4001126#+10修炼点\r\n#r普通模式#k：每完成一次可获得2-5个#v4000313##z4000313#\r\n#r普通模式#k：每天可免费进入2次，2次后需50#z4001126#+20修炼点\r\n\r\n#b#L1# #v03994115##l #L2# #v03994116##l";
                    cm.sendSimpleS(text);
                } else {
