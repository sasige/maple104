...
function action(mode, type, selection) {
 ...
 cm.sendSimple(selStr);
		...
		cm.dispose();
            ...
            break;
        case 7:
            if (cm.itemQuantity(4032398) >=5){
		cm.getVip(2,100);
		cm.gainItem(4032398, -5);
		cm.sendOk("兑换成功！成为VIP2");
		cm.dispose();
            } else {
                cm.sendOk("对不起，签到图章不足#v4032398#x5。");
		cm.dispose();
            }          
            break;
        case 8:
		...
		cm.sendOk("兑换成功！成为VIP3");
		cm.dispose();
            } else {
                cm.sendOk("对不起，签到图章不足#v4032398#x15。");
		cm.dispose();;
            }          
            break;
        case 9:
