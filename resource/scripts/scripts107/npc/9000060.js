...
if (selection == 0) {
        ...
        //cm.getC().getChannelServer().broadcastPacket(Packages.tools.MaplePacketCreator.serverNotice(0x10, cm.getC().getChannel(), "[征战魔女塔<简单>]" + " : " + "恭喜" + cm.getChar().getName() + "通过了魔女塔考验，获得了大量的黄金枫叶"));
	cm.dispose();
} else if (selection == 1) {
