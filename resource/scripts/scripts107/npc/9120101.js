...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.sendSimple("你好。如果你有#v5150040#，我可以为你设计一个绝版稀有发型，让你的形象与别人与众不同，怎么样想要体验一下吗？\r\n#b#L0#更换发型(使用皇家理发券)#l");
    } else if (status == 1) {
        if (selection == 0) {
            ...
            if (cm.getPlayerStat("GENDER") == 0) {
                ...
                hair_Colo_new = [37290, 37280, 37190, 37090, 37060, 37000, 34900, 34880, 34770, 34750, 34670, 34560, 34490, 34450, 34310, 34510, 34820, 37420, 37010, 37020, 37070, 37100, 37210, 37230, 37320, 36010, 33640, 34100, 34250, 34210, 34270, ];
            }
            for (var i = 0; i < hair_Colo_new.length; i++) {
                hair_Colo_new[i] = hair_Colo_new[i] + (hair % 10);
            }
            cm.sendYesNo("你真的要使用#v5150040#，随机更换发型吗？");
        }
    } else if (status == 2) {
        if (cm.setRandomAvatar(5150040, hair_Colo_new) == 1) {
            cm.sendOk("好了,让朋友们赞叹你的新发型吧!");
        } else {
            cm.sendOk("必须要有#v5150040#，我才能为你理发。");
        }
        cm.safeDispose();
    }
}