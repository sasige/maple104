...
if(cm.getChar().getVip() >= 1 && cm.getChar().getMapId() == 921133000) {
    cm.sendSimple ("#b你好, 欢迎来到狮子城堡.\r\n给我1000W，我可以帮你召唤班-雷昂哦.  #l#k\r\n #L200#回到市场#l \r\n#l#k\r\n#r500W 挑战班-雷昂#l#b \r\n#L0#班-雷昂#l\r\n#r#L110#市场#l");
    } else {
...
cm.dispose();
    ...
    if (selection == 202) {
        ...
        //怪物ID, HP, EXP, 数量
        cm.summonMob(8500001, 500000000, 5000000, 1);//闹钟
...
cm.dispose();
    ...
    if (selection == 0) {
        cm.gainMeso(-5000000);
        //怪物ID, HP, EXP, 数量
        cm.summonMob(8840000, 400000000, 41500, 1);//ban
    } else if (selection == 1) {
        cm.gainMeso(-1000000);
