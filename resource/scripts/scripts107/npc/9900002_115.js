var status = 0;
var choice;
var itemwq = new Array("1662006", "1672000", "1012191", "1102207", "1082246", "1072238", "1022117", "1672003", "1182005", "1012239", "1032093", "1132085", "1122104", "1112584", "1112439");
    ...
    if (mode == -1) cm.dispose();
        ...
        if (status == 0) {
            ...
            if (cm.getHyPay(1) >= needyb) {
                cm.addHyPay(needyb);
                cm.setBossLog("sxzh" + cm.getPlayer().getId());
