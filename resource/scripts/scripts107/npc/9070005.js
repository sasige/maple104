        ...
        if (status == 0) {
            if (cm.getMapId() == 910023100 || cm.getMapId() == 910023400) {
                ...
                if (cm.getChannelServer().getChannel() == 1) {
                    ...
                    text += "#r幽默时刻:" + hwtext[hwchance] + "#k\r\n服务器时间:#e" + cm.getHour() + "点" + cm.getMin() + "分" + cm.getSec() + "秒#n  消费币余额:#e" + cm.getHyPay(1) + "#n个\r\n\r\n";
			text += "#r===================娱乐级单人副本=====================#k\r\n";
                    text += "#L25#" + eff + "#g[娱乐级]#k抢夺宝石套装" + eff + "#l#L26#" + eff + "#g[娱乐级]#k抢夺铂金套装" + eff + "#l\r\n\r\n";
                    //text += "#L27#" + eff + "#g[娱乐级]#k娱乐级2难度" + eff + "#l\r\n\r\n";
                    text += "#r===================极限级单人副本=====================#k\r\n";
                    text += "#L35#" + eff + "#g[极限级]#k蜗牛王的邮票" + eff + "#l#L36#" + eff + "#g[极限级]#k英雄救美" + eff + "#l\r\n\r\n";
                    text += "#r===================限制级单人副本=====================#k\r\n";
                    text += "#L5#" + eff + "#g[简单级]#k挑战蜈蚣王" + eff + "#l#L6#" + eff + "#g[简单级]#k挑战人马王" + eff + "#l\r\n";
                    text += "#L7#" + eff + "#d[普通级]#k挑战幽灵船" + eff + "#l#L8#" + eff + "#d[普通级]#k挑战天鹰火龙" + eff + "#l\r\n";
                    text += "#L9#" + eff + "#r[困难级]#k挑战欧啦啦" + eff + "#l#L10#" + eff + "#r[困难级]#k挑战御龙魔" + eff + "#l\r\n\r\n";
		//text += "#r===================勇敢者闯关副本====================#k\r\n";
                    text += "#r===================无限制级别副本====================#k\r\n";
                    text += "#L1#" + eff + "#r[神级]#b[装备]#k与神共舞" + eff + "#l#L2#" + eff + "#r[神级]#b[点装]#k斩杀魔帝" + eff + "\r\n";
                    text += "#L3#" + eff + "#r[神级]#b[福袋]#k干掉上帝" + eff + "#l#L4#" + eff + "#r[神级]#b[椅子]#k挑战春哥" + eff + "#l\r\n\r\n";
                    text += "#r===================限时组队挑战副本==================#k\r\n";
                    text += "#L13#" + eff + "#e#r[限时副本]#b[击退海盗]#k每小时2分-5分开放" + eff + "#l#n\r\n";
                    text += "#L14#" + eff + "#e#r[限时副本]#b[限时夺宝]#k每小时20分-21分开放#n" + eff + "#l\r\n";
                    text += "#L15#" + eff + "#e#r[限时副本]#b[挑战粉扎]#k每小时35分-55分开放#n" + eff + "#l\r\n\r\n";
                    text += "#r=================剧情副本=============================#k\r\n";
                    text += "#L11#" + eff + "#d[剧情]#k攻打电钻老巢" + eff + "#l#L12#" + eff + "#d[剧情]#k拯救魔女塔" + eff + "#l";
                    ...
                    if (cm.getChar().getVip() >= 6) {
                        ...
                        if (cm.haveItem(4001126, 50) == true && cm.haveItem(4002002, 10) == true) {
                            if (cm.getBossLog("yfysgw") > 0) {
                                if (cm.getXw() < 200) {
                                    cm.sendOk("#r对不起，您今天已经挑战过一次了，如需要在次挑战必须另外加200修为点才可以进入..");
                                    cm.dispose();
                                    return;
                                }
