...
function end(mode, type, selection) {
    ...
    if (status == 0) {
        qm.sendOk("Ah, so you're the explorer people were talking about. I'm #bScarrs, the Royal Mushroom Scholar#k representing the Kingdom of Mushroom. So you need some #终结者iller Mushroom Spores#k?");
    } else if (status == 1) {
        qm.gainExp(4200);
        qm.sendOk("#终结者iller Mushroom Spores#k... I think i've heard of them before...");
