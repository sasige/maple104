...
function start() {
    var price = "\r\n\r\n#rRegular Skin/Hair/Eye/Color change: 1,500,000$.\r\nRoyal Hair change: 5,000,000$."
    cm.sendSimple("Hello there, do you want a new look? \r\n#L0#Skin#l\r\n#L1#Haircut#l\r\n#L5#Royal Haircut\r\n#L2#Hair Color#l\r\n#L3#Face#l\r\n#L4#Eye Color#l");
}
...
function action(mode, type, selection) {
    ...
    if (status == 1) {
        ...
        if (selection == 1) {
            for each(var i in cm.getPlayerStat("GENDER") == 0 ? hair : fhair)
                hairnew.push(i);
            ...
            for each(var j in cm.getPlayerStat("GENDER") == 0 ? face : fface)
                facenew.push(j);
            ...
            for each(var i in cm.getPlayerStat("GENDER") == 0 ? royalhair : royalfhair)
                hairnew.push(i);
            cm.sendStyle("Pick one?", hairnew);
        }
    } else if (status == 2) {
        //if (cm.getPlayer().getMeso() >= 1500000 || cm.getPlayer().isGM()) {
        if (beauty == 1)
        ...
        //if (cm.getPlayer().getMeso() >= 5000000 || cm.getPlayer().isGM()) {
        if (beauty == 6)
            cm.setHair(hairnew[selection]);
        //}
        cm.dispose();
