...
var returnTo = new Array(200000170,200000170);
var rideTo = new Array(200000170,200000170);
var birdRide = new Array(200090610,200090310);
var myRide;
var returnMap;
var map;
var docked;
...
function timeOut() {
	var iter = em.getInstance("SDtoJ4").getPlayers().iterator();
	while (iter.hasNext()) {
		var player = iter.next();
		player.changeMap(docked, docked.getPortal(0));
		em.getInstance("SDtoJ4").unregisterPlayer(player);
	}
	em.setProperty("isRiding","false");
	em.disposeInstance("SDtoJ4");
}
