...
var returnTo = new Array(140020300,140020300);
var rideTo = new Array(140020300,140020300);
var birdRide = new Array(200090060,200090070);
var myRide;
var returnMap;
var map;
var docked;
...
function timeOut() {
	var iter = em.getInstance("EnToJ1").getPlayers().iterator();
	while (iter.hasNext()) {
		var player = iter.next();
		player.changeMap(docked, docked.getPortal(0));
		em.getInstance("EnToJ1").unregisterPlayer(player);
	}
	em.setProperty("isRiding","false");
	em.disposeInstance("EnToJ1");
}
