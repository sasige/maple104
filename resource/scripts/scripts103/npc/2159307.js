function start() {
	if (cm.getChar().getMapId() == 931020011){
...
if (selection == 0) {
	...
	cm.gainItem(4001126,-400); 
        cm.summonMob(9400377,2100000000, 40000, 1);  
cm.serverNotice("『BOSS系统』：【"+ cm.getChar().getName() +"】信碧拉姐姐德好东西···~~~~~~~！！！·~!");
cm.getC().getChannelServer().broadcastPacket(net.sf.odinms.tools.MaplePacketCreator.serverNotice(0x10,cm.getC().getChannel(),"『欧碧拉』"+" : "+"信碧拉姐姐德好东西···~~~~~~~！！！啊啊啊啊！.~!"))
	cm.dispose();}
} else if (selection == 1) {
