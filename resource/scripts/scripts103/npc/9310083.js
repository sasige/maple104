...
var itemSet = new Array(2340000,3010070,1402037,1402063,
1432013,4001021,2022101,1082149,1432046,3010099,1432047,
4001017,2340000,3010014,4001021,1442087,2000005,4001021,
3010073,1402036,4001021,3010075,2022118,1442088,3010045,
1442039,1452059,2022100,4001021,2022109,1122017,1472068,
2022151,1432056,2022251,1402044,1402014,1402046,2022060);
...
var rand2 = Math.floor(Math.random() * 5);
	...
	if (status == 0) {
		...
		cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.odinms.tools.MaplePacketCreator.getItemMegas(cm.getC().getChannel(),cm.getPlayer().getName() + " : " + "从未来女皇任务中获得丰厚宝藏！大家一起恭喜他（她）吧！！！",toDrop, true).getBytes());	
