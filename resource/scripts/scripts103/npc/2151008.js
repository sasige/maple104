...
var types=new Array("魔力显圣枪","魔力神光戟","魔力蝶翼杖","魔力冰轮杖","魔力断手刃[飞短刀-运]","魔力威震天","魔力狂鲨锯[飞短刀-力]","魔力惊电弓","魔力冥雷弩","魔力大悲赋[拳套]","魔力孔雀翎[海盗刀]","魔力凤凰锍[海盗枪]","魔力飞天刃[副刀]");
...
function action(mode, type, selection) {
			...
			status--;
		        ...
		        if (status == 0) {
					cm.sendSimple("#r你好，我的朋友，我的ID:"+cm.getNpc()+"\r\n我是本服的每日工资派发员,有什么需要我效劳的么~~#b\r\n#r#L2#┈═☆我是会员.我的地盘我作主.要#e领取今日工资#n☆═┈#l\r\n#r#L1#┈═☆我是会员.我的地盘我作主.要#e进入会员地图#n☆═┈#l\r\n#r#L3#┈═☆我是会员.我的地盘我作主.要#e领取会员装备#n☆═┈#l");
