...
cm.dispose();
if (selection == 0) {
        if (!cm.haveItem(4001564,1)) {
        cm.sendOk("抱歉，你没有1张#v4001564#无法为你开启#e#r");
        } else if (!cm.haveItem(4001564,1)) {
        }else{
	cm.gainItem(4001564,-1);
        cm.summonMob(9400263,2000000000, 40000, 1);  
cm.serverNotice("『春哥2012副本』：【"+ cm.getChar().getName() +"】带领他的队友开始挑战钢铁春哥兽,友情提示小心你的菊花");     
	cm.dispose();}
} else if (selection == 1) {
