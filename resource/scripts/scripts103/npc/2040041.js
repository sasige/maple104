...
if (selection == 0) {
        ...
        cm.summonMob(8820001,1000000000, 40000, 1);     
cm.serverNotice("『BOSS系统』：【"+ cm.getChar().getName() +"】已经召唤出时间宠儿-缤纷PB,叱喝道我 等你等的好苦~!");
cm.getC().getChannelServer().broadcastPacket(net.sf.odinms.tools.MaplePacketCreator.serverNotice(0x10,cm.getC().getChannel(),"『时间宠儿-缤纷PB』"+" : "+"小娃娃想杀我,你当我是娃娃呀"))
