...
cm.sendOk("哈哈,换取成功,快去砸极品装备吧");cm.getC().getChannelServer().broadcastPacket(net.sf.odinms.tools.MaplePacketCreator.serverNotice(0x10,cm.getC().getChannel(),"『"+ cm.getChar().getName() +"』Vip⑥"+" : "+"在[会员⑥秘密-刷必成祝福]成功换取卷轴,大家恭喜他(她)"))
cm.dispose(); }
}else if (selection == 4) {
if (cm.haveItem(4310027,30) == false){
cm.sendOk("抱歉,您没有带来30枚传说币#v4310027#,所以我不能和你交换"); cm.dispose();
