...
if(cm.getChar().getVip() >= 1 && cm.getChar().getMapId() == 551030200 && cm.countMonster()<10000000000) {
    cm.sendSimple ("#v1002927##v1002927##v1002927##v1002927##v1002927##v1002927##v1002927##v1002927##v1002927##b死熊,和死狮子又不听话了吗?\r\n我来帮你把它拽出来吧,不过得给我钱\r\n100W很公道了吧\r\n请选择你要虐的BOSS.  #l#k\r\n #L110#（市场）操你妹打个BOSS还要钱哥闪了~！#l \r\n#l#k\r\n                 #r100W BOSS对抗#l#b\r\n             #L0#暴力熊#l #L1#爱心狮#l\r\n\r\n\r\n#v1002926##v1002926##v1002926##v1002926##v1002926##v1002926##v1002926##v1002926##v1002926#");
    } else {
    cm.sendOk("请满足以下条件才可以使用\r\n\r\n#r#e不要再找个地图召唤过多的boss（暴力熊,心巴狮）")
    }
}
...
cm.dispose();
    ...
    if (selection == 0) {
        cm.gainMeso(-1000000);
        //怪物ID, HP, EXP, 数量
        cm.summonMob(9420541,50000000, 1150, 1);//蝙蝠怪
cm.serverNotice("『BOSS系统』：【"+ cm.getChar().getName() +"】已经召唤出淫荡的暴力熊,拍卖超级传送进入");
    } else if (selection == 1) {
        cm.gainMeso(-1000000);
