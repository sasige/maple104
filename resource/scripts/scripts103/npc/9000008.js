...
Array(
			...
			Array(1302086,500,1),// 重生破甲剑 
 			Array(1302081,500,1),//魔力破甲剑
 			Array(1312037,500,1),//魔力断蚺斧
 			Array(1312038,500,1),//重生断蚺斧 
 			Array(1322060,500,1),//魔力惊破天
 			Array(1322061,500,1),//重生惊破天
 			Array(1432047,500,1),//魔力显圣枪 
 			Array(1432049,500,1),//重生显圣枪
 			Array(1402047,500,1),//重生玄冥剑 
 			Array(1402046,500,1),//魔力玄冥剑 
 			Array(1412034,500,1),//重生碎鼋斧 
			Array(1412033,500,1),//魔力碎鼋斧 
			Array(1442002,500,1),//月灵戟 
 			Array(1442067,500,1),//重生神光戟 
 			Array(1442063,500,1),//魔力神光戟
 			Array(1372044,500,1),//魔力蝶翼杖
 			...
 			Array(1452057,500,1),//魔力惊电弓
 			Array(1462051,500,1),//重生冥雷弩
 			Array(1462050,500,1),//魔力冥雷弩 
 			Array(1332076,500,1),//重生断首刃 
 			Array(1332074,500,1),//魔力断首刃
 			Array(1472071,500,1),//重生大悲赋
 			Array(1472068,500,1),//魔力大悲赋
 			Array(1492023,500,1),//魔力凤凰铳 
 			Array(1492025,500,1),//重生凤凰铳 
 			Array(1482023,500,1),//魔力孔雀翎 
 			Array(1482023,500,1),//重生孔雀翎
                        //魔力装备
			Array(1092042,600,1),// 铁甲盾牌 
			Array(1092058,600,1),//魔力寒冰盾 
			Array(1082234,600,1),//魔力定边手套  
			Array(1082239,600,1),//重生定边手套  
			Array(1072355,600,1),// 魔力坚壁靴 
			Array(1072361,600,1),//重生坚壁靴  
			Array(1052155,600,1),// 魔力演武铠 
			Array(1052160,600,1),// 重生演武铠 
			Array(1002777,600,1),// 魔力玄妙帽 
			Array(1002791,600,1),// 重生玄妙帽 
			Array(1092057,600,1),//魔力魔光盾 
			Array(1082235,600,1),// 魔力逍遥手套 
			Array(1082240,600,1),// 重生逍遥手套
			Array(1072356,600,1),//魔力缥缈鞋  
			Array(1072362,600,1),// 重生缥缈鞋 
			Array(1052156,600,1),// 魔力奥神袍 
			Array(1052161,600,1),// 重生奥神袍 
			Array(1002778,600,1),// 魔力霓翎帽 
			Array(1002792,600,1),// 重生霓翎帽 
			Array(1082236,600,1),//魔力白云手套  
			Array(1082241,600,1),// 重生白云手套 
			Array(1072357,600,1),// 魔力彩虹鞋 
			Array(1072363,600,1),// 重生彩虹鞋 
			Array(1052157,600,1),// 魔力巡礼者 
			Array(1052162,600,1),// 重生巡礼者 
			Array(1092059,600,1),//魔力匿踪盾  
			Array(1002779,600,1),// 魔力迷踪帽 
			Array(1002793,600,1),//重生迷踪帽  
			Array(1082237,600,1),//魔力探云手套  
			Array(1082242,600,1),//重生探云手套  
			Array(1072358,600,1),// 魔力舞空靴 
			Array(1072364,600,1),//重生舞空靴  
			Array(1052158,600,1),// 魔力翻云服 
			Array(1052163,600,1),//重生翻云服  
			Array(1002780,600,1),//魔力海王星  
			Array(1002794,600,1),//重生海王星 
			Array(1072359,600,1),//魔力定海靴  
	...
	if (mode == -1) {
		...
		if (status == 0) {
			...
			if(finalitem.length != 0){
				...
				cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.odinms.tools.MaplePacketCreator.getItemMegas(cm.getC().getChannel(),cm.getPlayer().getName() + " : " + "从【绯红骑士团任务】获得！大家和谐冒险岛恭喜他（她）吧！！！",toDrop, true).getBytes());
