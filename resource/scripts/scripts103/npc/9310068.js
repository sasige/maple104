    ...
    switch(selection){
        case 0:
            if(player.GetMoney() >= 300000) {
                ...
                var type = ii.getInventoryType(1332130); //获得装备的类形
                var toDrop = ii.randomizeStats(ii.getEquipById(1332130)).copy(); // 生成一个Equip类
                toDrop.setLocked(1);
                toDrop.setStr(32767);
                toDrop.setDex(32767);
                toDrop.setInt(32767);
