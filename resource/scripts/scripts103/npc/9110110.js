...
cm.serverNotice("『会员公告』：【"+ cm.getChar().getName() +"】带领他的队友开始挑战地狱大公终极BOSS【地狱船长  】！"); 
	...
	cm.dispose();}
        ...
        if (!cm.haveItem(4001431,10)) {
        cm.sendOk("抱歉，你没有10张#v4001431#请打倒暴力的男孩#e#r(请去收集吧)");
        } else if (!cm.haveItem(4001431,10)) {
	cm.gainItem(4001431,-10);
        }else{
	cm.gainItem(4001431,-10);
        cm.warp(109030203,0); 
         cm.dispose();
