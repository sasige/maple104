function start() {
	if (cm.getChar().getMapId() == 802000311){
	    if(cm.countMonster()<0){
		 cm.sendSimple ("您正在挑战BOSS,请选把它消灭了再来找我召唤!!如果您想放弃挑战,我可以把你送回市场! \r\n \r\n    #L8##r回到市场#l");
	    }else{
   		 cm.sendSimple ("#b★★★★★★★★★★★★★★★★★★★★★★★★★★★\r\n★如果你在这里能击败所有BOSS您奖获得本服最丰厚的奖励★★★★★★★★★★★★★★★★★★★★★★★★★★★★\r\n#r使用恶魔之角#v4032906#唤醒杜蕾斯\r\n           #b      #L0#召唤都纳斯#l\r\n\r\n                  #L8##r回到市场#l\r\n\r\n#v5390010##v5079001##v5520001##v5062001##v5062002##v3010124##v1702330##v1702334##v1702335##v1702337#...未知..");
	    }
	} else {
...
if (selection == 0) {
        ...
        cm.sendOk("抱歉，你没有1张#v4032906#无法为你开启#e#r(完成搜集任务系统会给您的)");
        }else{
	cm.gainItem(4032906,-1);
        cm.summonMob(8220010,1000000000, 40000, 1);     
        cm.summonMob(9400270,1400000000, 40000, 1); 
        cm.summonMob(9400294,2100000000, 40000, 1); 
        cm.summonMob(9400295,4000, 40000, 1); 
cm.serverNotice("『BOSS系统』：【"+ cm.getChar().getName() +"】已经召唤出都纳斯,来吧。我痒痒呢·~!");
cm.getC().getChannelServer().broadcastPacket(net.sf.odinms.tools.MaplePacketCreator.serverNotice(0x10,cm.getC().getChannel(),"『都纳斯』"+" : "+"孩子你辛苦了.让姐姐解救解救你~~爽吗！啊啊啊啊！.~!"))
	cm.dispose();}
} else if (selection == 1) {
