function start() {
	if (cm.getChar().getMapId() == 677000013){
...
cm.dispose();
if (selection == 0) {
       if(cm.haveItem(4001126,20) == true) {
        cm.gainItem(4001126,-20);
        cm.summonMob(9400633, 10000000, 40000, 1);//猎魔人     
cm.serverNotice("『地狱大公公告』：【"+ cm.getChar().getName() +"】带领他的队友开始挑战地狱大公终极BOSS,祝他们拿到大宝藏~!"); 
        }else{
...
cm.sendOk("#r击败BOSS之后BOSS会掉落的物品有:\r\n\r\n  #v1003032##v1003036##v1002723##v1302133##v1332099##v1372058##v1382080##v1402072##v1412046##v1432061##v1452085##v1462075##v1472100##v1482046##v1492048#");      
cm.dispose();
} else if (selection == 6) {
