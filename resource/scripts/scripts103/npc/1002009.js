...
if(cm.getChar().getVip() >= 1 && cm.getChar().getMapId() == 910340100&& cm.countMonster()<5) {
    cm.sendSimple ("#b你好,我能为你召唤鳄鱼.\r\n  #l#k\r\n                 #L110#回到市场#l \r\n#l#k\r\n               #r1000W召唤珍稀动物\r\n            #L10##b召唤凶残的鳄鱼宝宝#l");
    } else {
    cm.sendOk("#r我是鳄鱼皮鞋专卖员\r\n鳄鱼皮太抢手了\r\n一次只能挑战5只...")
    }
}
...
cm.dispose();
    ...
    if (selection == 0) {
        ...
        cm.gainMeso(-10000000);
        cm.summonMob(9300001, 1000000, 1150, 10);//天鹰
...
cm.dispose();
    ...
    if (selection == 41) {
        ...
        cm.gainMeso(-5000000);
        cm.summonMob(8140000, 500000, 1000, 4);//白狼
