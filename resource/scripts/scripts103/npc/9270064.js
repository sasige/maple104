function start() {
	if (cm.getChar().getMapId() == 109030203){
	    if(cm.countMonster()<0){
		 cm.sendSimple ("您正在挑战BOSS,请选把它消灭了再来找我召唤!!如果您想放弃挑战,我可以把你送回市场! \r\n \r\n    #L8##r回到市场#l");
	    }else{
   		 cm.sendSimple ("#b★★★★★★★★★★★★★★★★★★★★★★★★★★★\r\n如果你想进入下一关挑战牛逼BOSS你就必须要通过走到顶\r\n#r加油吧,找到正确的入口,终极boss等着你~!#b \r\n★★★★★★★★★★★★★★★★★★★★★★★★★★★\r\n#rBoss有可能掉落\r\n#v1112585#  #v1003114#  #v1702208#  #v1102248#  #v1012170#  #v1402063#  #v3013000#\r\n\r\n#l");
    }
	} else {
...
if (selection == 0) {
       if(cm.getMeso() >= 1) {
        cm.gainMeso(-1);
        cm.summonMob(9001014,99999999, 40000, 5);     
        }else{
...
cm.serverNotice("『会员公告』：【"+ cm.getChar().getName() +"】带领他的队友开始挑战地狱大公终极BOSS【地狱船长  】！"); 
	...
	cm.dispose();}
        ...
        if (!cm.haveItem(4001431,1)) {
        cm.sendOk("抱歉，你没有1张#v4001431#请打倒暴力的男孩#e#r(请去收集吧)");
        } else if (!cm.haveItem(4001431,1)) {
