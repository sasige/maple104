...
cm.serverNotice("『BOSS系统』：【"+ cm.getChar().getName() +"】已经召唤出未来统治者·希纳斯女皇,叱喝道我 等你等的好苦~!");
cm.getC().getChannelServer().broadcastPacket(net.sf.odinms.tools.MaplePacketCreator.serverNotice(0x10,cm.getC().getChannel(),"『希纳斯女皇』"+" : "+"小萝卜头想K掉我?你还早出生一百年.~!"))
	cm.dispose();}
} else if (selection == 1) {
