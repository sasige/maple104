...
if(cm.getChar().getVip() >= 1 && cm.getChar().getMapId() == 280030000 && cm.countMonster()<2) {
    cm.sendSimple ("#v4001017##v4001017##v4001017##v4001017##v4001017##v4001017##v4001017##v4001017##v4001017#\r\n#b召唤扎昆\r\n我来帮你把它拽出来吧,不过得给我钱\r\n5000W很公道了吧\r\n请选择你要虐的BOSS.  #l#k\r\n #L110#（市场）操你妹打个BOSS还要钱哥闪了~！#l \r\n#l#k\r\n                 #r500W BOSS对抗#l#b\r\n             #L0#扎昆BOSS#l#l\r\n\r\n\r\n#v4001017##v4001017##v4001017##v4001017##v4001017##v4001017##v4001017##v4001017##v4001017#");
    } else {
...
cm.dispose();
    ...
    if (selection == 202) {
        ...
        //怪物ID, HP, EXP, 数量
        cm.summonMob(8500001, 1000000000, 50000, 1);//闹钟
...
cm.dispose();
    ...
    if (selection == 0) {
        cm.gainMeso(-50000000);
        //怪物ID, HP, EXP, 数量
cm.summonMob(8800000,1000000000, 10000, 1);  
cm.summonMob(8800003,100000000, 2000, 1); 
cm.summonMob(8800004,100000000, 2000, 1); 
cm.summonMob(8800005,100000000, 2000, 1); 
cm.summonMob(8800006,100000000, 2000, 1);  
cm.summonMob(8800007,100000000, 2000, 1); 
cm.summonMob(8800008,100000000, 2000, 1); 
cm.summonMob(8800009,100000000, 2000, 1);   
cm.summonMob(8800010,100000000, 2000, 1);    cm.serverNotice("『BOSS系统』：【"+ cm.getChar().getName() +"】已经召唤出扎昆,拍卖超级传送进 入");
    } else if (selection == 1) {
        cm.gainMeso(-1000000);
