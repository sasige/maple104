function start() {
	if (cm.getChar().getMapId() == 689013001){
	    if(cm.countMonster()<1000000){
		 cm.sendSimple ("#b#b你好,我能为您召唤粉色扎昆.\r\n\r\n#r如果您想快点打死那你就站在祭坛的中间点我召唤 #l#k\r\n    #L0##v3010313##b召唤粉色扎昆#v3010313#\r\n#l#k\r\n                          #L8#回到市场#l");
	    }else{
   		 cm.sendSimple ("#b#b你好,我能为您召唤粉色扎昆.\r\n\r\n#r如果您想快点打死那你就站在祭坛的中间点我召唤 #l#k\r\n    #L0##v3010313##b召唤粉色扎昆#v3010313#\r\n#l#k\r\n                          #L8#回到市场#l");
	    }
	} else {
...
cm.dispose();
if (selection == 0) {
        if (!cm.haveItem(4001124,1)) {
        cm.sendOk("#r抱歉，只可以召唤一次");
        }else{
	cm.gainItem(4001124,-1);
        cm.summonMob(9400900, 2100000000, 40000, 1);//主体
cm.serverNotice("『BOSS系统』：【"+ cm.getChar().getName() +"】已经召唤粉色扎昆,★★★★★★★★★"); 
	cm.dispose();}
} else if (selection == 1) {
