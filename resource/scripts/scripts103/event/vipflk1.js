...
function monsterstart() {
	...
	while (iter.hasNext()) {
		var eim = iter.next();
			var mob = net.sf.odinms.server.life.MapleLifeFactory.getMonster(8860010);
...
map.spawnMonsterOnGroudBelow(mob, new java.awt.Point(636, -181));
 map.broadcastMessage(net.sf.odinms.tools.MaplePacketCreator.serverNotice(5, " 阿卡伊勒已经被召唤 !请在规定时间内打到它!"));
	}
}
