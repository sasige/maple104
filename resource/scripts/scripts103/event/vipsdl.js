...
function monsterstart() {
	...
	while (iter.hasNext()) {
		var eim = iter.next();
			var mob = net.sf.odinms.server.life.MapleLifeFactory.getMonster(9300394);
...
map.spawnMonsterOnGroudBelow(mob, new java.awt.Point(182, 209));
 map.broadcastMessage(net.sf.odinms.tools.MaplePacketCreator.serverNotice(5, " BOSS已经召唤,请在规定时间内打到它!"));
	}
}
