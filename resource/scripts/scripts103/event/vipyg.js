...
function monsterstart() {
	...
	while (iter.hasNext()) {
		var eim = iter.next();
			var mob = net.sf.odinms.server.life.MapleLifeFactory.getMonster(9800008);
...
map.spawnMonsterOnGroudBelow(mob, new java.awt.Point(-697, 89));
 map.broadcastMessage(net.sf.odinms.tools.MaplePacketCreator.serverNotice(5, " 摇滚之魂已经被召唤!请在规定时间内打到它!"));
	}
}
