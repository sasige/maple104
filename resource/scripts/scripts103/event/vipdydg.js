...
function monsterstart() {
	...
	while (iter.hasNext()) {
		var eim = iter.next();
			var mob = net.sf.odinms.server.life.MapleLifeFactory.getMonster(9400612);
			...
			overrideStats.setExp(5250); 
			overrideStats.setMp(500); 
			mob.setOverrideStats(overrideStats); 
			mob.setHp(hprand);
			eim.registerMonster(mob);
			
map.spawnMonsterOnGroudBelow(mob, new java.awt.Point(278, 45));
 map.broadcastMessage(net.sf.odinms.tools.MaplePacketCreator.serverNotice(5, "牛魔王已经被召唤!请在规定时间内打到它!"));
	}
}
