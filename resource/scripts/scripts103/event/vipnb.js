...
function monsterstart() {
	...
	while (iter.hasNext()) {
		var eim = iter.next();
			var mob = net.sf.odinms.server.life.MapleLifeFactory.getMonster(9800082);
			...
			overrideStats.setMp(400000); 
			mob.setOverrideStats(overrideStats); 
			mob.setHp(hprand);
			eim.registerMonster(mob);
			
map.spawnMonsterOnGroudBelow(mob, new java.awt.Point(460, 275));
 map.broadcastMessage(net.sf.odinms.tools.MaplePacketCreator.serverNotice(5, " 尼贝隆战舰已经被召唤!"));
	}
}
