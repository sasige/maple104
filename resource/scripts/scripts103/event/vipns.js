...
function monsterstart() {
	...
	while (iter.hasNext()) {
		var eim = iter.next();
			var mob = net.sf.odinms.server.life.MapleLifeFactory.getMonster(9300039);
...
map.spawnMonsterOnGroudBelow(mob, new java.awt.Point(-855, 563));
 map.broadcastMessage(net.sf.odinms.tools.MaplePacketCreator.serverNotice(5, " 远古精灵已经被召唤!请在规定时间内打到它!"));
	}
}
