...
function monsterstart() {
	...
	while (iter.hasNext()) {
		var eim = iter.next();
			var mob = net.sf.odinms.server.life.MapleLifeFactory.getMonster(9400705);
...
map.spawnMonsterOnGroudBelow(mob, new java.awt.Point(-10, 95));
 map.broadcastMessage(net.sf.odinms.tools.MaplePacketCreator.serverNotice(5, " 盖福克斯已经被召唤!请在规定时间内打到它!"));
	}
}
