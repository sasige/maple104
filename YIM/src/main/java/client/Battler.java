...
public class Battler implements Serializable {
    ...
    public void setStatus(MonsterStatusEffect mse) {
        ...
        if ((this.ability == PokemonAbility.Immunity) && (stat == MonsterStatus.ÖÐ¶¾)) {
            return;
        }
        if ((this.ability == PokemonAbility.Insomnia) && (stat == MonsterStatus.¿Ö»Å)) {
            return;
        }
        if ((this.ability == PokemonAbility.Limber) && (stat == MonsterStatus.Ó°Íø)) {
            return;
        }
        if ((this.ability == PokemonAbility.MagmaArmor) && (stat == MonsterStatus.½á±ù)) {
            return;
        }
        if ((this.ability == PokemonAbility.OwnTempo) && (stat == MonsterStatus.ÌôÐÆ)) {
            return;
        }
        if ((this.ability == PokemonAbility.WaterVeil) && (stat == MonsterStatus.ÁÒÑæÅçÉä)) {
            return;
        }
        if (this.status != null) {
            return;
